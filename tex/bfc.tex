...
counted 3.05 billion unique 55-mers occurring twice or more, but only 2.84
...
less influential than uncorrectable reads caused by repeats which tend to to
systematic. We recommend to use longer $k$-mer for spectrum-based error
correction.

Error correction is primarily used in the context of {\it de novo} assembly.
However, assembling many human data sets and evaluating the resulting
assemblies is still nontrivial. Closely studying the effect of error
correction in human assembly will be one of our future directions.
